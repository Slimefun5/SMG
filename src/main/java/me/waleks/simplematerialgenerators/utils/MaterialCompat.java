package me.waleks.simplematerialgenerators.utils;
 ...
 * running server. Keeps SimpleMaterialGenerators loadable on legacy versions (e.g. 1.8)
 * where modern constants like {@code SMOOTH_STONE} or {@code STONE_BRICKS} are absent.
 */
